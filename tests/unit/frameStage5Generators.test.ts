...
const CASES: GenCase[] = [
  ...
  { id: 'ambient-mist', gen: generateAmbientMist, expectsModelInSvg: true, expectsParamInSvg: true },
  { id: 'ambient-twilight', gen: generateAmbientTwilight, expectsModelInSvg: true, expectsParamInSvg: true },
  { id: 'ambient-ocean', gen: generateAmbientOcean, expectsModelInSvg: true, expectsParamInSvg: true },
  { id: 'ambient-forest', gen: generateAmbientForest, expectsModelInSvg: true, expectsParamInSvg: true },
  { id: 'ambient-film', gen: generateAmbientFilm, expectsModelInSvg: true, expectsParamInSvg: true },
  { id: 'ambient-cream', gen: generateAmbientCream, expectsModelInSvg: true, expectsParamInSvg: true },
  { id: 'ambient-rose', gen: generateAmbientRose, expectsModelInSvg: true, expectsParamInSvg: true },
  { id: 'ambient-mono', gen: generateAmbientMono, expectsModelInSvg: true, expectsParamInSvg: true },
