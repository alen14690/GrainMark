...
export const TASTE_PRESETS: TasteReference[] = [
  ...
  ref('land-20', 'photo-1419242902214-272b3f66ee7a', 'Milky Way', 'landscape', '银河拱桥', '#0A0A20', ['#1A1A40', '#3030A0'], '#6060FF', 8000, 30, 18, 70, -400, 0.85, -8, '#3030A0', '#050510'),
  ...
  ref('film-04', 'photo-1419242902214-272b3f66ee7a', 'Film Night', 'film', '胶片夜景', '#1A1828', ['#2A2840', '#4A4860'], '#6A6890', 5800, 22, 25, 55, -30, 0.82, -5, '#2A2840', '#0C0C14'),
